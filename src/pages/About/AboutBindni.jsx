  ...
  return (
    <div className=" text-gray-800">
      ...
      >
        ...
        <p className=" lg:text-xl text-gray-700 mb-8 leading-relaxed">
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="mt-14 max-w-4xl mx-auto text-center px-5"
      >
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-start py-20 px-5"
      >
        <div>
      ...
      <motion.div
        ...
        transition={{ duration: 0.8 }}
        viewport={{ once: true }}
        className="mt-14 max-w-5xl mx-auto text-center px-5"
      >
      ...
      <motion.div
        ...
        transition={{ duration: 0.8 }}
        viewport={{ once: true }}
        className="w-full p-1 flex flex-col lg:flex-row justify-center items-center py-20 lg:gap-20"
      >
        <h1 className="text-2xl font-bold mb-4 cinzel-font text-center lg:text-left">
